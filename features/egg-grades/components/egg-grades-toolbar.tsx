...
type EggGradesToolbarProps = {
  onCreateClick: () => void;
};

export function EggGradesToolbar({ onCreateClick }: EggGradesToolbarProps) {
    ...
    <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
      <div className="grid min-w-0 flex-1 gap-2 sm:grid-cols-2 lg:flex lg:flex-row lg:flex-wrap lg:items-center">
        <div className="relative min-w-0 sm:col-span-2 lg:max-w-xs lg:flex-1">
          ...
          <Input
            placeholder="Cari nama atau deskripsi grade..."
            value={search}
        ...
        <Select value={usage} onValueChange={(v) => updateFilter("usage", v)}>
          ...
          <SelectContent>
            ...
            <SelectItem value="in_use">Sudah dipakai</SelectItem>
