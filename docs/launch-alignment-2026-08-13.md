...
> **Update 2026-08-20:** stok kini per-grade — semua grade aktif masuk `EggStock`/`EggMovement` (bukan Item `Egg`); baris penjualan wajib memilih grade. Lihat [`egg-sales-stock.md`](./egg-sales-stock.md) + [`smoke-egg-sales.md`](./smoke-egg-sales.md). HDP/FCR tetap memakai TB (GAP-014 terpisah).
